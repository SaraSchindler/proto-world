...
4. **Rote Pfeile:** rote Pfeile zeigen an, dass ein Satz (Konklusion oder Prämisse) einen anderen angreift und nicht beide zugleich wahr sein können, d.h. wenn Satz A wahr ist, muss Satz B falsch sein, wenn Satz B wahr ist, muss Satz A falsch sein. Es ist aber auch möglich, dass beide Argumente falsch sind.
5. **Rote Diamantdoppelpfeile:** Auch rote Diamantdoppelpfeile zeigen an, dass sich zwei Sätze angreifen, aber nun muss einer der beiden Sätze wahr sein und der andere muss dann falsch sein (d.h. anders als bei roten Pfeilen können nicht beide falsch sein). Die beiden Sätze müssen immer gegenteilige Wahrheitswerte haben. 
